...
func (h handler) GetTableView(c *gin.Context) {
	...
	var result []struct {
		...
		SourceStationCoordinates GeoData `gorm:"serializer:json" json:"source_station_geo_data"`
		...
		ConsumerStationCoordinates GeoData `gorm:"serializer:json" json:"consumer_station_geo_data"`
		...
		LocationAreaConsumerCoordinates GeoData `gorm:"serializer:json" json:"location_area_consumer_geo_data"`
