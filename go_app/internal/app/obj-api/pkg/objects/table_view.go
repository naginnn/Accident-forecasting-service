...
func (h handler) GetTableView(c *gin.Context) {
	var result []struct {
		...
		ConsumerStationId          string `json:"consumer_station_id"`
		...
		LocationDistrictConsumerId   string `json:"location_district_consumer_id"`
		LocationDistrictConsumerName string `json:"location_district_consumer_name"`

		LocationAreaConsumerId          string `json:"location_area_consumer_id"`
